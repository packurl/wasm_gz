...
const worker=await new Promise(r=>{
  ...
  // const worker=new Worker(new URL('./zopfli_worker_script.js',import.meta.url));
  const worker=new Worker(new URL('./zopfli_worker_script.mjs',import.meta.url),{type:'module'});
